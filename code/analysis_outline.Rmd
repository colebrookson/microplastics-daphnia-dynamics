...
where $\alpha$ is a 'basal' response (response at zero/low-dose concentrations), $\beta$ is the rate of decay in the response, and $\gamma$ is the threshold. The data ${x_i, y_i}$ where $x$ is the concentration, and $y$ is the observed response. 
